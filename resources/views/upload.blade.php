    ...
    <div class="container mt-5">
        <form action="{{ route('fileUpload') }}" method="post" enctype="multipart/form-data" id="theForm">
            ...
            <div class="d-flex align-items-center" style='position: relative;'>
                ...
                <button style="height: fit-content; width: fit-content ;position: absolute; right: -96px; top: 8px;" class="addtextbox btn-info border-0 p-2 rounded-1 rounded text-capitalize" type="button"> text
                    input</button>
            </div>
            <script>
            ...
            const handleLoadText = (e) => { // change name and data here
                ...
                Array.from(inputs).map(inp => {
                    if (inp.dataset.index === e.dataset.index) {
                        ...
                        const docRegex = /\.doc$/i; // Case-insensitive match for .doc
